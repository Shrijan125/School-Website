...
const SlideShow = () => {
  ...
  return (
    <div className="relative mt-5">
      ...
      >
        <SwiperSlide>
          <Image src={images[0]} fill className="object-cover"></Image>
        </SwiperSlide>
        <SwiperSlide>
          <Image src={images[1]} fill className="object-cover"></Image>
        </SwiperSlide>
        <SwiperSlide>
          <Image src={images[2]} fill className="object-cover"></Image>
        </SwiperSlide>
        <SwiperSlide>
          <Image src={images[3]} fill className="object-cover"></Image>
        </SwiperSlide>
        <SwiperSlide>
          <Image src={images[4]} fill className="object-cover"></Image>
        </SwiperSlide>
      </Swiper>
